            ...
            <div>
                <div className="flex justify-center mt-[25px]">
                    <a href="" className="mx-3">
                        <svg className="w-[35px] h-[35px] text-(--svg-base-color) hover:text-(--base-color) cursor-pointer" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
