        ...
        <div className="py-15 mx-35 bg-gray-800/25 rounded-4xl shadoow-xl">
            <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
                <div className="flex flex-col items-center md:items-start gap-6">
                    ...
                    <div className="flex md:flex-col gap-6 text-gray-700 mt-6">
                        <div className="flex justify-between">
                            ...
                            <p className="w-45 pt-2 pl-3 text-white">Resume</p>
                        </div>
                        <div className="flex justify-between">
                            <a href="#">
                                <svg className="w-[35px] h-[35px] text-(--svg-base-color) hover:text-(--base-color)" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <p className="w-45 pt-2 pl-3 text-white">Github Repository</p>
                        </div>
                        <div className="flex justify-between ">
                            <a href="#">
                                <svg className="w-[35px] h-[35px] text-(--svg-base-color) hover:text-(--base-color)" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <p className="w-45 pt-2 pl-3 text-white">LinkedIn Profile</p>
                        </div>
                    </div>
                </div>
