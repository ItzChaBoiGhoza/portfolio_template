    ...
    <section id="about" className="min-h-screens py-40">
        ...
        <div className="">
            <div className="max-w-8xl mx-50 grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
                <div className="flex flex-col items-center md:items-start gap-6 my-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-gray-700 mx-auto">
                        <div className="flex justify-between">
                            <a href="#">
                                <svg className="w-[35px] h-[35px] text-(--svg-base-color) hover:text-(--base-color)" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
